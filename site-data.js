...
const DEFAULT_DATA = {
  ...
  products: [
    { id: 1, name: "Zippo Çakmak", price: "150,00₺", img: "https://images.unsplash.com/photo-1547996160-81dfa63595aa?w=400&q=80" },
    { id: 2, name: "Bakır Bilezik", price: "250,00₺", img: "https://images.unsplash.com/photo-1622398925373-3f91b1e275f5?w=400&q=80" },
    { id: 3, name: "Beyaz Bere", price: "175,00₺", img: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=400&q=80" },
    { id: 4, name: "Deri Eldiven", price: "400,00₺", img: "https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?w=400&q=80" },
    { id: 5, name: "Rüzgar Çakmak", price: "350,00₺", img: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&q=80" },
    { id: 6, name: "Adalet Heykeli", price: "2.500,00₺", img: "https://images.unsplash.com/photo-1589578527966-fdac0f44566c?w=400&q=80" },
    { id: 7, name: "Zarif Çelik Kolye", price: "300,00₺", img: "https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400&q=80" },
    { id: 8, name: "Ehram Takım", price: "5.000,00₺", img: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=400&q=80" },
    { id: 9, name: "Ehram Çocuk Yelek", price: "5.000,00₺", img: "https://images.unsplash.com/photo-1591085686350-798c0f9faa6f?w=400&q=80" },
    { id: 10, name: "Ehram Yelek", price: "5.000,00₺", img: "https://images.unsplash.com/photo-1584184924103-e310d9dc82fc?w=400&q=80" },
    { id: 11, name: "Ehram Yelek (Krem)", price: "4.000,00₺", img: "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?w=400&q=80" },
    { id: 12, name: "İnci Kolye", price: "3.000,00₺", img: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=400&q=80" },
    { id: 13, name: "Leopar Bere", price: "400,00₺", img: "https://images.unsplash.com/photo-1510771463146-e89e6e86560e?w=400&q=80" },
    { id: 14, name: "Yonca Bileklik", price: "200,00₺", img: "https://images.unsplash.com/photo-1573408301185-9519f94f3e23?w=400&q=80" },
    { id: 15, name: "Çelik Balık Sırtı Kolye", price: "350,00₺", img: "https://images.unsplash.com/photo-1635767798638-3e25273a8236?w=400&q=80" },
    { id: 16, name: "Taş Saat Kule", price: "1.100,00₺", img: "https://images.unsplash.com/photo-1509225770129-fbcf8a696c0b?w=400&q=80" },
    { id: 17, name: "Siyah Zippo Çakmak", price: "200,00₺", img: "https://images.unsplash.com/photo-1518893494013-481c1d8ed3fd?w=400&q=80" }
  ]
};
